...
class Wide_ResNet(nn.Module):
    def __init__(
        self, block, layers, num_classes=144,
...
def wide_resnet_bn_imagenet64(in_ch=3, in_dim=64):
    model = Wide_ResNet(BasicBlock, [1, 1, 1], num_classes=144, widen_factor=10, base_width=16, pool=False, dense=True, in_ch=in_ch, in_dim=in_dim)
    return model
